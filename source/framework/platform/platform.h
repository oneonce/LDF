...
#define IIC_MUX_CAMERA                          (1 << 1) // 触摸使用的IIC(硬件设计决定)
#define IIC_MUX_EEPROM                          (1 << 2) // EEPROM使用的IIC(硬件设计决定)
#define IIC_MUX_TOUCH                           (1 << 3) // 触摸使用的IIC(硬件设计决定)
//#define IIC_MUX_...
...
#define ETH_MUX_RJ45                            (1 << 2) // 有限(硬件设计决定)
//#define ETH_MUX_...
