...
extern "C" {
	...
	typedef struct
	{
		...
		**函数返回: 过滤器索引
		**********************************************************************************************************************/
		uint16_t (*add_filter)(enum CAN_ID can_id, uint16_t* filter_index, uint32_t mask, uint8_t filter_id);
		...
		**********************************************************************************************************************/
		uint16_t (*del_filter)(uint16_t filter_index);
		...
		**                <0:  参考ERROR_CODES
		**********************************************************************************************************************/
		int32_t (*sync_read)(can_message_t* msg, uint32_t msg_cnt, const uint32_t millisecond);
